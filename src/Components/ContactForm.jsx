...
// We'll use a different approach to load reCAPTCHA
...
const ContactForm = () => {
  ...
  useEffect(() => {
    ...
    window.onRecaptchaLoad = () => {
      ...
      if (window.grecaptcha && captchaContainerRef.current) {
        recaptchaRef.current = window.grecaptcha.render(captchaContainerRef.current, {
          sitekey: '6Ley1xQrAAAAAAzAW_w8Lm2COd0N6CanJZegdKTr',
          theme: 'dark',
          callback: (value) => setCaptchaValue(value),
    ...
    if (window.grecaptcha) {
      ...
      // Load script only if it hasn't been loaded yet
    ...
    <section className="p-4 lg:w-3/4" id="contact">
      ...
      >
        <div className="flex flex-col space-y-4">
          ...
          >
            {/* Replace the ReCAPTCHA component with a div that will be used to render the widget */}
            <div ref={captchaContainerRef} className="g-recaptcha"></div>
            {error.captcha && (
